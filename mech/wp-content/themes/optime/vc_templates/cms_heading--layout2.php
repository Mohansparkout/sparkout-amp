...
<?php if(!empty($text)):?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="cms-heading layout2 <?php echo esc_attr( $el_class.' '.$align_text.' '.$el_parallax_class.' '.$animation_classes ); ?>" <?php echo esc_attr($parallax_speed); ?>>
    ...
    <?php if (!empty($description)){?>
        <div class="description">
            <p <?php echo !empty($description_styles) ? 'style="' . esc_attr($description_styles) .'"' : ''?>><?php echo wp_kses_post( $description ); ?></p>
        </div>
    <?php } ?>
</div>
<?php endif;?>