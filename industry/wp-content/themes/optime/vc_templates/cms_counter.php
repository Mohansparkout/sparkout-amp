...
?>
<div id="<?php echo esc_attr($html_id);?>" style="border-color:<?php echo esc_attr($border_color);?>;background-color:<?php echo esc_attr($border_color);?>;width:<?php echo esc_attr($width);?>" class="cms-counter layout1 <?php echo esc_attr( $el_parallax_class.' '.$animation_classes.' '.$el_class ); ?>" <?php echo esc_attr($parallax_speed); ?>>

    <div class="cms-counter-inner">
        <?php if(!empty($icon_image_url) && !empty($digit)) : ?>
        <div class="cms-counter-content">
            <div class="cms-counter-content-inner" style="background-color: <?php echo esc_attr($background);?>;">
