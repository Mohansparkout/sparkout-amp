...
?>
<div class="cms-fancybox <?php if (empty($description)){echo esc_attr('no-desc');} ?> layout1 <?php echo esc_attr($el_parallax_class.' '.$el_class.' '.$animation_classes); ?>" <?php echo esc_attr($parallax_speed); ?> style="background-color:<?php echo esc_attr($background_color);?>;padding:<?php echo esc_attr($fancybox_padding);?>;">
