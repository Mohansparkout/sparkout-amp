...
if(!empty($testimonials)) : ?>
    ...
    <div id="<?php echo esc_attr($html_id);?>" class="cms-testimonial-carousel layout2 svg-nav owl-carousel <?php echo esc_attr( $el_parallax_class.' '.$el_class ); ?>" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?> <?php echo esc_attr($parallax_speed); ?> style="<?php if(!empty($background)) { echo 'background-color:'.esc_attr($background).';'; } ?>">
