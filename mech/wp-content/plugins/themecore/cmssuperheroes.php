...
/**
 *
 * Plugin Name: ThemeCore
 * Plugin URI: https://7oroof.com/
 * Description: This plugin is package compilation some addons, which is developed for Visual Comporser plugin.
 * Version: 1.2.2
 * Author: 7oroof
 * Author URI: https://7oroof.com/
 * Copyright 2023 7oroof.com. All rights reserved.
...
//        register_activation_hook(__FILE__, array($this, 'activation_hook'));
        ...
        require_once CMS_LIBRARIES . 'LinkedIn/LinkedIn.php';
    ...
    function cmsActionInit()
    {
        ...
        if(is_file(get_template_directory().'/vc_elements/cms_carousel.php')){
            require_once get_template_directory().'/vc_elements/cms_carousel.php';
        }else{
            require_once CMS_DIR . '/shortcodes/cms_carousel.php';
        }
        if(is_file(get_template_directory().'/vc_elements/cms_bootstrap_tabs.php')){
            require_once get_template_directory().'/vc_elements/cms_bootstrap_tabs.php';
        }else{
            require_once CMS_DIR . '/shortcodes/cms_bootstrap_tabs.php';
        }
    }
    ...
    function cmsInit()
    {
        ...
        if (apply_filters('cms_scss_on', false)) {
            // scss compiler library v0.7.5
            if (!class_exists('\Leafo\ScssPhp\Compiler')) {
                require_once CMS_LIBRARIES . 'scss/scss.inc.php';
            }
        }
...
//            add_action("redux/extensions/before", array($this, 'redux_extensions'), 30);
    ...
    function cms_admin_script()
    {
        ...
        wp_enqueue_script('admin-main-js', CMS_JS . 'admin-main.js', array('jquery'));
    }
