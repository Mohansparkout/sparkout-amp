...
$args = array(
    ...
    'base' => 'cms_case_studies_carousel',
    ...
    'params' => array(
        ...
        array(
            ...
            'shortcode' => 'cms_case_studies_carousel',
            'heading' => esc_html__('Shortcode Template', 'optime'),
            'admin_label' => true,
            'std' => 'cms_case_studies_carousel.php',
...
class WPBakeryShortCode_cms_case_studies_carousel extends CmsShortCode
{
