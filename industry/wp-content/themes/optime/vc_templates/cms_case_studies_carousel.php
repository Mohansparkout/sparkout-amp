...
extract(shortcode_atts(array(
    ...
    'animation'             => '',
    'el_class'             => '',
    'img_size'             => 'optime-medium',
    'el_parallax'   => 'false',
    'el_parallax_speed'   => '1.5',
), $atts));
wp_enqueue_script( 'owl-carousel' );
wp_enqueue_script( 'optime-carousel' );
$html_id = cmsHtmlID('cms-case-studies-carousel');
...
<div id="<?php echo esc_attr($html_id) ?>" class="cms-case-studies-carousel owl-carousel animation-time <?php echo esc_attr( $el_parallax_class.' '.$el_class ); ?>" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?> <?php echo esc_attr($parallax_speed); ?>>
            ...
            <div class="grid-item-inner">
                    ...
                    <div class="item-holder">
                        ...
                        <div class="item-content">
                            <?php echo wp_trim_words( $post->post_excerpt, $num_words = 19, $more = null ); ?>
                        </div>
