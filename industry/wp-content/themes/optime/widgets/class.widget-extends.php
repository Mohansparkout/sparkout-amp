 ...
 * @version 1.2
 * @package wpvolter
 * @since   wpvolter 1.0.3
 */

class WPVolter_Widget_Extends
{
    /**
     * Construction
     */
    ...
    function extend_widget_form( $widget, $return, $instance )
    {
        ...
        <p>
            ...
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-use_theme_style"><?php esc_html_e( 'Use Theme Style', 'optime' ); ?></label>
        </p>
        <?php
        }
        ...
        ?>
        <p>
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-el_class"><?php esc_html_e( 'CSS Class', 'optime' ); ?></label>
        ...
        <p>
            ...
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-hide_title"><?php esc_html_e( 'Hide widget title', 'optime' ); ?></label>
        </p>
        <?php
