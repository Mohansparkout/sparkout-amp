...
<div id="<?php echo esc_attr($html_id) ?>" class="cms-grid cms-case-studies-grid cms-grid-layout-modern <?php echo esc_attr($el_parallax_class.' '.$el_class); ?>" <?php echo esc_attr($parallax_speed); ?>>
