...
vc_map(
    array(
        'name'     => esc_html__('Case Studies Grid', 'optime'),
        'base'     => 'cms_case_studies_grid',
        'class'    => 'vc-cms-case-studies-grid',
        'category' => esc_html__('Theme Shortcodes', 'optime'),
        'params'   => array(
            array(
                'type' => 'cms_template_img',
                'param_name' => 'cms_template',
                'shortcode' => 'cms_case_studies_grid',
                'heading' => esc_html__('Shortcode Template', 'optime'),
                'admin_label' => true,
                'std' => 'cms_case_studies_grid.php',
...
class WPBakeryShortCode_cms_case_studies_grid extends CmsShortCode
{
    protected function content($atts, $content = null)
    {
        $html_id = cmsHtmlID('cms-case-studies-grid');
